...
@Component({
  selector: 'app-lpo-admin-draft-new-agreement',
  templateUrl: './lpo-admin-draft-new-agreement.component.html',
  styleUrls: ['./lpo-admin-draft-new-agreement.component.css']
})
export class LpoAdminDraftNewAgreementComponent {
 ...
 fetchProjectId(): void {
   this.reqDraftService.get_ProjectId_from_cmDraftReq().subscribe(
     (response) => {
       if (response.success) {
