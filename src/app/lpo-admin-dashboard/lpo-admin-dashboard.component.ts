...
@Component({
  selector: 'app-lpo-admin-dashboard',
  templateUrl: './lpo-admin-dashboard.component.html',
  styleUrls: ['./lpo-admin-dashboard.component.css']
})
export class LpoAdminDashboardComponent implements OnInit{
 // leadForm: FormGroup;
 userId: number  = 0;
 agreements: any[] = [];
 addhocs: any[] = [];
