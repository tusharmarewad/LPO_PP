...
@Component({
  selector: 'app-lpo-admin-add-leads',
  templateUrl: './lpo-admin-add-leads.component.html',
  styleUrls: ['./lpo-admin-add-leads.component.css']
})
export class LpoAdminAddLeadsComponent {
  leadForm: FormGroup;
