...
@Component({
  selector: 'app-lpo-admin-draft-ad-hoc',
  templateUrl: './lpo-admin-draft-ad-hoc.component.html',
  styleUrls: ['./lpo-admin-draft-ad-hoc.component.css']
})
export class LpoAdminDraftAdHocComponent {
