...
@Component({
  selector: 'app-lpo-admin-lead-status',
  templateUrl: './lpo-admin-lead-status.component.html',
  styleUrls: ['./lpo-admin-lead-status.component.css']
})
export class LpoAdminLeadStatusComponent {
